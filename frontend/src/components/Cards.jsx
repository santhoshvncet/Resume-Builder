...
export const TemplateCard =({thumbnailImg,isSelected , onSelect})=>{
  ...
  return(
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden 
      cursor-pointer transition-all duration-500 hover:font-stretch-105 hover:shadow-lg rounded-3xl ${isSelected ?'border-violet-500 shadow-lg shadow-violet-500/20 bg-violet-50' :'border-gray-200 hover:border-violet-300' }`} 
      onClick={onSelect}
      >
        {thumbnailImg ?
        <div className='relative w-full h-full overflow-hidden'>
          ...
          {/** hover effect */}
          <div className='absolute inset-0 bg-gradient-to-t from-violet-100/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
        </div>  
        : (
          <div className=' w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 to-violet-600 to-fuchsia-50  '>
