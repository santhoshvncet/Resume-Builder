...
const CreateResumeForm = () => {
  ...
  return (
    <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
      ...
      <p className='text-gray-600 mb-4'>Give your resume a title to get Started. you can customize everything later</p>
      ...
      <button className='w-full py-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-black
