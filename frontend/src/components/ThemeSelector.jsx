...
const ThemeSelector = ({selectedTheme,setSelectedTheme,resumeData,onClose}) => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        '>
            <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={tabValue} />

            <button className='w-full sm:w-auto flex items-center justify-center gap-3 px-6
             py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 transition-all shadow-lg hover:shadow-xl ' onClick={handleThemeSelection}>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
            ...
            <div className=' lg:col-span-3 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6' ref={resumeRef}>
                <RenderResume templateId={selectedTemplate.theme || ""} resumeData={resumeData || DUMMY_RESUME_DATA}
