...
import { buttonStyles, contactInfoStyles, containerStyles, iconStyles, statusStyles } from '../assets/dummystyle'
...
import { AdditionalInfoForm, CertificationInfoForm, ContactInfoForm, EducationDetailsForm, ProfileInfoForm, ProjectDetailForm, SkillsInfoForm, WorkExperienceForm } from './Forms.jsx'
...
const uploadResumeImages = async () => {
  try {
    ...
    // If you also want to upload profileImage:
    // formData.append("profileImage", selectedProfileImageFile);

    // --- API call (POST, not PUT) ---
    const uploadResponse = await axiosInstance.put(
      API_PATHS.RESUME.UPLOAD_IMAGES(resumeId),
      formData,
      { headers: { "Content-Type": "multipart/form-data" } }
  ...
  return (
    <DashBoardLayout>
        <div className={containerStyles.main}>
            ...
            <div className='flex fex-wrap items-center gap-3'>
            ...
            <div className={containerStyles.grid}>
              <div className={containerStyles.formContainer}>
                ...
                <div className='p-4 sm:p-6'>
                  ...
                  <div className=' flex flex-wrap items-center juswnd
                   gap-3'>
        ...
        {/** Model data*/}
        <Model isOpen={openThemeSelector} onClose={()=>setOpenThemeSelector(false)} 
         title="change title" >
         ...
         <Model isOpen={openPreviewModal} 
         onClose={()=>setOpenPreviewModal(false)}
         title={resumeData.title}
         showActionBtn
         actionBtnText={isDownloading ? "Generating..." : downloadSuccess ? "Downloaded": "downloaded PDf"}
         actionBtnIcon={
          isDownloading ? (
